...
/*   Updated: 2018/09/11 18:30:50 by jagarcia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_ini_sprites(t_data *data, t_sdl *Graph)
{
	...
	Graph->heart[0] = SDL_CreateRGBSurfaceWithFormat(0, 79, 90, 32, 372645892);
	if (SDL_BlitSurface(sprite, &(SDL_Rect){0, 0, 79, 90}, Graph->heart[0], NULL) < 0)
