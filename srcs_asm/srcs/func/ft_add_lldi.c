...
/*   Updated: 2018/09/17 12:52:12 by jpinyot          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_line		*ft_add_lldi(char *l, int cnt, int j, int n_line)
{
	...
	if ((i = ft_strcmp_index_jmp(&l[j], "lldi")) == -1 || l[i] == 0)
		ft_error_order(n_line, 0, "lldi", "lldi\tr2,r2,r2");
	i += j;
	line = ft_newline(NULL, 14, l, 2);
	if (l[i] == DIRECT_CHAR)
